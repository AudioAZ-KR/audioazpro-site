...
(function(){
  ...
  window.AZ_PAY = {
    ...
    paddle:  { clientToken: "", env: "sandbox", priceIds: { KV: "pri_01m1p7nqc1ktc8w5tqsm95hg33", KI: "", TALLY: "pri_01m1p7tnqhs25nr9r1422kn7es" } }   // Paddle 샌드박스 · clientToken(공개) 입력 시 해외 결제 버튼 활성,
